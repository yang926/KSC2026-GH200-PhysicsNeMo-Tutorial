...
| nvbandwidth | 메모리 복사 경로의 전송 대역폭 | Copy Engine(`_ce`)과 SM 커널(`_sm`) 두 방식의 양방향 대역폭 확인 |
...
| 14:15–14:25 | 프로파일 대상을 선택하고 Nsight Systems 실행 | API·커널·메모리 활동 | 선택한 `.nsys-rep` 생성 |
| 14:25–14:30 | nvbandwidth를 CE·SM 두 방식으로 실행 | 양방향 복사 대역폭 | 측정 결과 저장 |
